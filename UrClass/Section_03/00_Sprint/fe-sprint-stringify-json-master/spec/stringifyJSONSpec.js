...
// 여러분이 구현한 stringifyJSON 을 테스트하는데 사용됩니다.
...
// 여러분이 구현한 stringifyJSON 을 테스트하는데 사용됩니다.
// hint: JSON 은 function 과 undefined 를 stringify 해서는 안됩니다.
// 따라서 여러분들은 아래의 key, value 쌍들을 stringify 하지 않도록 해야 합니다.
const unstringifiableValue = {
  functions: function () {},
  undefined: undefined,
};

describe("stringifyJSON 는 JSON.stringify 함수를 실행했을 때와 같은 결과를 리턴해야 합니다.", function () {
  ...
  it("함수와 undefined 는 stringify 되지 않습니다.", function (done) {
