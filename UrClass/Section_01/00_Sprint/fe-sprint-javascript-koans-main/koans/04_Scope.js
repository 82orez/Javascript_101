describe('scope 대해서 학습합니다.', function () {
  //  scope 는 변수의 값(변수에 담긴 값)을 찾을 때 확인하는 곳을 말합니다. 반드시 기억하시기 바랍니다.
  ...
  it('lexical scope 에 대해서 확인합니다.', function () {
    let message = 'Outer';
  ...
  it('default parameter 에 대해 확인합니다.', function () {
    // 아마 매개변수가 입력 되지 않을 경우 5를 디폴트 값으로 한다는 의미인 것 같음.
  ...
  it('클로저(closure)에 대해 확인합니다.', function () {
    ...
    /*
    mdn 에 따르면 클로저의 정의는 다음과 같습니다. 반드시 기억하시기 바랍니다.
    ...
    특이하게도 자바스크립트는 함수가 호출되는 환경과 별개로, 기존에 선언되어 있던 환경 - 어휘적 환경 - 을 기준으로 변수를 조회하려고 합니다.
  ...
  it('lexical scope 와 closure 에 대해 다시 확인합니다.', function () {
    let age = 27;
    let name = 'jin';
    let height = 179;
